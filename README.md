...
<style>
    ...
    h1{
        color: rgb(50, 103, 149);
    }
    h2{
        color: rgb(48, 109, 161);
    }
    h3{
        color:tomato;
        align:center;
...
.styled form {
        ...
        .styled [type="button"] {
            ...
            background-color: #2286c9; /* initial background color */
        ...
        .styled [type="submit"] {
            ...
            background-color: #0e80cc; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
...
<body >
    ...
    <h3>"People who need something really important they must know how what is the process to get it"</h3>
        ...
        <div class="login">
            <div class="login-box">
            <p style="color: rgb(66, 172, 199);">DONT HAVE AN ACCOUNT</p>
            <a href="sign.html">
...
<footer style="background-color:darkmagenta;margin-top: 110; border: none;">
    <P style="color:#ffffff; ;"align="center">Designed and Devoloped by HARSETHA J (212223220032) </P>
</footer>
</html>
...
<html>
    ...
    <body>
        ...
        <img src="PRO.jpg" height="500" width="800">
    </center>
    </body>
    <footer style="background-color:darkmagenta;margin-top: 25; border: none;">
        <P style="color:#ffffff; ;"align="center">Designed and Devoloped by HARSETHA J (212223220032)</P>
    </footer>
</html>
...
<style>
    ...
    .styled form {
        ...
        .styled [type="submit"] {
            ...
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth 
transition */
        }
        .styled [type="submit"]:hover {
            background-color:purple; /*background color on hover */
...
<body>
    ...
    <div class="photos">
    <img src="HARSETHA J.jpg" height="150" width="150">
    <img src="RAMYA K.jpg" height="150" width="150">
    <img src="RENU P.jpg" height="150" width="150">
    <img src="SHENA T.jpg" height="150" width="150">
    <img src="YAMUNA R.jpg" height="150" width="150">
    <img src="ANITHA G.jpg" height="150" width="150">
   
</div>
<div CLASS="names">
    <P>HARSETHA J</P>    
    <P style="margin-left:50;">MS RAMYA K</P>    
    <P style="margin-left:90;">Ms RENU P </P>    
    <P style="margin-left:100;">MS SHENA T</P>    
    <P style="margin-left:50;">MS YAMUNA R</P>    
    <P style="margin-left:30;">MS ANITHA G</P>     
</div>
<DIV class="position">
    <p>FOUNDER </p>
...
scroll-padding-left: 5px;
border:2px solid rgb(198, 101, 101);
}
.message textarea {
        background-color: rgb(238, 236, 236); /* Set the default background color */
...
.message    textarea:focus {
        ...
        color: rgb(176, 79, 79); /* Set the text color when in focus */
    }
    </style>
</head>
<body>
...
![alt text](<vijay/softapp/static/Screenshot (32).png>)
![alt text](<vijay/softapp/static/Screenshot (33).png>)
![alt text](<vijay/softapp/static/Screenshot (34).png>)
![alt text](<vijay/softapp/static/Screenshot (35).png>)
![alt text](<vijay/softapp/static/Screenshot (36).png>)
![alt text](<vijay/softapp/static/Screenshot (37).png>)
